...
import stabilaclick from '../assets/images/stabilaclickLogo.svg';
import stabilaclickBlue from '../assets/images/stabilaclickBlue.svg';
import stabilaclickRightArrow from '../assets/images/stabilaclickRightArrow.svg';
...
class LeftMenu extends React.Component {
  ...
  componentDidMount() {
    ...
    if (!this.props.network.isConnected) {
      this.props.network.initStabilaClickWallet(
        () => {
          this.props.mountedActions && this.props.mountedActions();
        },
        () => {
          // if a user do not login StabilaClick wallet, we should do something
    ...
    // we shoule listen StabilaClick to reload the webpage to get new account info
    this.props.network.listenStabilaClick();
  }
  ...
  render() {
    ...
    return (
      <>
        <div className="header-container">
          <div className="menu-scroll-frame">
            <div className="menu-scroll">
              <h6 className="header-logo">STABILA DAPP Logo</h6>
          ...
          {loginModalStep === 1 ? (
            <div className="center">
              ...
              <div className="wallet-list">
                ...
                >
                  <span>
                    <img src={stabilaclick} className="stabilaclick-logo" alt="" />
                  </span>
                  <div>
                    <span className="wallet-txt">{intl.get('login_modal.stabilaclick')}</span>
                    <img src={stabilaclickRightArrow} className="stabilaclick-right-arrow-logo" alt="" />
                  </div>
                </div>
              </div>

              <div className="stabilaclick-tips">
                <span>{intl.get('wallet.accept_tips')} </span>
                <a href="https://chrome.google.com/webstore/detail/stabilaclick%EF%BC%88%E6%B3%A2%E5%AE%9D%E9%92%B1%E5%8C%85%EF%BC%89/ibnejdfjmmkpcnlpebklmnkoeoihofec">
        ...
        >
          <div>
            <img className="mb16" src={stabilaclickBlue} />
            <div className="address-con">
              <div className="tip-text mb16 fs12 c-5A5E89">{intl.get('account_modal.connect_with_stabilaclick')}</div>
